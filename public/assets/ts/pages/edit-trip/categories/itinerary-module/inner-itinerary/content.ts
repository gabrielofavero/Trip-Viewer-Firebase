	...
	return `<div class="inner-programacao" id="inner-programacao-box">
                <div id="inner-programacao-tela-principal">
                    <div class="nice-form-group" style="display: ${Object.values(selects).some((item: any) => item.ativo) ? "block" : "none"}">
                        ...
                        <button id="inner-programacao-item-associado" class="btn input-botao placeholder-text" data-action="open-inner-itinerary-item" data-index="${j}" style="margin-top: 8px;">${translate("trip.itinerary.link_item")}</button>
                    </div>
