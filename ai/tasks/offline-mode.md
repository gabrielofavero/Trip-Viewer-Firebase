...
>
> **Strategy:** A Python build script that exports Firestore data → downloads all images → generates a self-contained HTML/CSS/JS site with all Firebase dependencies stripped out and replaced by local JSON data. Images are also saved
>
